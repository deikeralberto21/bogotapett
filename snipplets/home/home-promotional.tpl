                ...
                {% if has_banner %}
                    <div class="col-md-9">
                        <div class="textbanner{% if settings.theme_rounded %} box-rounded textbanner-shadow{% endif %}">
                            {% if banner_url %}
                                    {% if in == 1 %}
                                         <a class="textbanner-link" href="https://beethovenpetcare.com/como-comprar/"{% if banner_title %} title="{{ banner_title }}" aria-label="{{ banner_title }}"{% else %} title="{{ 'Banner de' | translate }} {{ store.name }}" aria-label="{{ 'Banner de' | translate }} {{ store.name }}"{% endif %}>
                                    {% endif %}
                                    {% if in == 2 %}
                                    ...
                                    {% endif %}
                                    {% if in == 3 %}
                                         <a class="textbanner-link" href="https://beethovenpetcare.com/marcas1/"{% if banner_title %} title="{{ banner_title }}" aria-label="{{ banner_title }}"{% else %} title="{{ 'Banner de' | translate }} {{ store.name }}" aria-label="{{ 'Banner de' | translate }} {{ store.name }}"{% endif %}>
                                    {% endif %}
                                    {% if in == 4 %}
